...
// 
//       <service name="MiddleServiceApp.EntretienSyncService" behaviorConfiguration="MiddleServiceApp.EntretienSyncServiceBehavior">
//         <host>
//           <baseAddresses>
//             <add baseAddress ="http://localhost:8080/EntretienSyncService/"/>
//           </baseAddresses>
//         </host>
//         <endpoint address ="" binding="wsHttpBinding" contract="MiddleServiceApp.IEntretienSyncContract"/>
//         <endpoint address="mex" binding="mexHttpBinding" contract="IMetadataExchange" />
//       </service>
// 
// and the following to the serviceBehaviors section
// 
//        <behavior name="MiddleServiceApp.EntretienSyncServiceBehavior">
